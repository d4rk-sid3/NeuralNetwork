...
features:
  - icon: "🧱"
    ...
    details: Clean Glados architecture with data-oriented design for optimal performance and flexibility.
    link: /Architecture/ARCHITECTURE
  - icon: "🔧"
  ...
  - icon: "⚙️"
    title: Build & Deploy
    details: CMake build system with Conan package management and CI/CD.
    link: /Build/BUILD_GUIDE
---

<img src="index_image.jpg" alt="GLADOS" style="width: 1200px; height: auto; margin-top: 40px; margin-bottom: 80px" />
